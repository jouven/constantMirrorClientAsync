...
HEADERS += \
    ...
    mirrorConfig.hpp \
    downloadClient.hpp \
    fileListRequestClientThread.hpp \
    fileListRequestClientSocket.hpp \
...
LIBS += -lsignalso -ltextQtso -lfileHashQtso -lbaseClassQtso -lessentialQtso -lthreadedFunctionQtso -lqmutexUMapQtso -lsslUtilsso -lssl -lcrypto
